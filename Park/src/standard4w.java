...
public class standard4w {
	...
	public standard4w()throws ClassNotFoundException, SQLException {
		try {
	...
	public void insert(String i,String n) throws SQLException {
		...
		String q="insert into slot.standard4w (slot,vehiclenumber) values ('"+slot+"' ,'"+vehiclenumber+"') ";///////////////////////////////////////////////INSERT
		Statement s = con.createStatement();
		s.executeUpdate(q);
		
	}
	public void insert(String vehiclenumber) throws SQLException {
		String q12="select count(*) from  slot.standard4w ";//////////////////////////////////counter of rows
		...
		if(n12<10) { 
			...
			String u ="select * from  slot.standard4w where vehiclenumber ='"+0+"' ";
			Statement s =con.createStatement();
			...
			if(status==1) {
				...
				String zero="0";
				String ui = "update  slot.standard4w set vehiclenumber  = '"+n+" ' where vehiclenumber ='"+zero+"'";/////////////////////////////////////////////////UPDATE
				...
				String q121="select count(*) from  slot.standard4w ";//////////////////////////////////counter of rows
	...
	public void delete(String id) throws SQLException {
		...
		String idd=id;
		String u ="select * from slot.standard4w where vehiclenumber ='"+idd+"' ";
		Statement s =con.createStatement();
...
/*		while(rs.next()) {
		...
		String newName = "0";
		String ui = "update slot.standard4w  set vehiclenumber  = '"+newName+" ' where slot ='"+slo+"'";/////////////////////////////////////////////////UPDATE
		Statement s12= con.createStatement();
		s12.executeUpdate(ui);
